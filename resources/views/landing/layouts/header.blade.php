                ...
                <div class="d-flex flex-column gap-3">
                  ...
                  <div class="hstack gap-3 justify-content-center">
                    {{-- <a href="sign-in.html"
                      ...
                      In</a> --}}
                    <a href="sign-up.html"
                      class="btn btn-dark text-white fs-6 bg-dark px-3 py-2 w-50 hstack justify-content-center">Login</a>
                  </div>
                </div>
                <div>
                  <a class="text-dark" href="tel:+1-212-456-7890">+62812-7564-5952</a>
                  <a class="fs-8 text-dark fw-bold" href="mailto:info@wrappixel.com">teamhydtech@gmail.com</a>
                </div>
              </div>
            </ul>
          </div>
